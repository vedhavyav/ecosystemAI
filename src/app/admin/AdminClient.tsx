...
import { Download, Users, TrendingDown, Factory } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-emerald-900/40 border border-emerald-500/20 p-6 rounded-3xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-emerald-100/60 font-bold tracking-widest uppercase text-sm">
                Active Workforce
              </h3>
            </div>
          ...
          <div className="bg-emerald-900/40 border border-emerald-500/20 p-6 rounded-3xl">
            ...
            <div className="text-5xl font-black text-white">
              14.2 <span className="text-2xl text-emerald-500">Tons</span>
            </div>
          </div>
          ...
          <div className="bg-emerald-900/40 border border-emerald-500/20 p-6 rounded-3xl">
            ...
            <div className="text-5xl font-black text-white">
              480.5 <span className="text-2xl text-emerald-500">Tons</span>
            </div>
          </div>
        </div>
