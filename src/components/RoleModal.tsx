        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-black text-white mb-3">Welcome to Ecosystem AI</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-emerald-100/60 leading-relaxed">
                  Track your personal carbon footprint, view recommendations, and earn green credits.
                </p>
              </button>
              ...
              >
                ...
                <p className="text-emerald-100/60 leading-relaxed">
                  Manage B2B enterprise dashboards, track Scope 3 emissions, and export BRSR compliance reports.
                </p>
              </button>
