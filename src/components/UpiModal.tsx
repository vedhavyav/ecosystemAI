        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex flex-col items-center text-center mt-4">
              ...
              <h3 className="text-2xl font-black text-white mb-2">Redeem Green Credits</h3>
              <p className="text-emerald-200/80 mb-8 font-medium">Scan the QR code below via any UPI app (GPay, PhonePe, Paytm) to claim your reward.</p>
              ...
              <LiquidButton onClick={onClose} className="w-full text-lg py-4 font-bold tracking-wide">
                Done
              </LiquidButton>
            </div>
          </motion.div>
