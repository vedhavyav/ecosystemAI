...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 bg-white/10 border border-emerald-500/20 backdrop-blur-xl py-1 px-1 rounded-full shadow-[0_4px_20px_rgba(0,0,0,0.1)]">
        {items.map((item) => {
